...
| `status`     | ENUM('pending', 'approved', 'rejected'), NOT NULL, DEFAULT 'pending' | 사용자의 계정 상태.                        |
...
| `maincategory_ko` | VARCHAR(45), NOT NULL                                             | FAQ의 메인 카테고리 (한국어).                                      |
| `maincategory_en` | VARCHAR(45), NOT NULL                                             | FAQ의 메인 카테고리 (영어).                                        |
| `subcategory_ko`  | VARCHAR(45), NOT NULL                                             | FAQ의 서브 카테고리 (한국어).                                      |
| `subcategory_en`  | VARCHAR(45), NOT NULL                                             | FAQ의 서브 카테고리 (영어).                                        |
| `question_ko`     | VARCHAR(300), NOT NULL                                            | FAQ의 질문 (한국어).                                               |
| `question_en`     | VARCHAR(300), NOT NULL                                            | FAQ의 질문 (영어).                                                 |
| `answer_ko`       | VARCHAR(1000), NOT NULL                                           | FAQ의 답변 (한국어).                                               |
| `answer_en`       | VARCHAR(1000), NOT NULL                                           | FAQ의 답변 (영어).                                                 |
...
| `faq_id`      | INT, DEFAULT NULL                    | 관련 FAQ의 ID. `faqs` 테이블의 외래 키. |
| `username`    | VARCHAR(45), NOT NULL                | 변경을 수행한 사용자의 사용자 이름.     |
| `prev_faq`    | VARCHAR(3000), NOT NULL              | FAQ의 이전 상태.                        |
| `new_faq`     | VARCHAR(3000), NOT NULL              | FAQ의 새로운 상태.                      |
...
| `feedback_score` | INT, DEFAULT NULL                    | 질문에 대한 피드백 점수.                |
| `feedback`       | VARCHAR(300), DEFAULT NULL           | 질문에 대한 피드백.                     |
...
| `faq_id`       | INT, DEFAULT NULL                                                 | FAQ의 ID. `faqs` 테이블의 외래 키.           |
| `related_faqs` | JSON, DEFAULT NULL                                                | 관련 FAQ ID의 JSON 배열.                     |
...
| `maincategory_ko`   | VARCHAR(45), NOT NULL                                             | 시니어 FAQ의 메인 카테고리 (한국어).                                      |
| `maincategory_en`   | VARCHAR(45), NOT NULL                                             | 시니어 FAQ의 메인 카테고리 (영어).                                        |
| `subcategory_ko`    | VARCHAR(45), NOT NULL                                             | 시니어 FAQ의 서브 카테고리 (한국어).                                      |
| `subcategory_en`    | VARCHAR(45), NOT NULL                                             | 시니어 FAQ의 서브 카테고리 (영어).                                        |
| `detailcategory_ko` | VARCHAR(45), NOT NULL                                             | 시니어 FAQ의 상세 카테고리 (한국어).                                      |
| `detailcategory_en` | VARCHAR(45), NOT NULL                                             | 시니어 FAQ의 상세 카테고리 (영어).                                        |
| `answer_ko`         | VARCHAR(1000), NOT NULL                                           | 시니어 FAQ의 답변 (한국어).                                               |
| `answer_en`         | VARCHAR(1000), NOT NULL                                           | 시니어 FAQ의 답변 (영어).                                                 |
...
| `senior_faq_id`   | INT, DEFAULT NULL                    | 관련 시니어 FAQ의 ID. `senior_faqs` 테이블의 외래 키. |
| `username`        | VARCHAR(45), NOT NULL                | 변경을 수행한 사용자의 사용자 이름.                   |
| `prev_senior_faq` | VARCHAR(3000), NOT NULL              | 시니어 FAQ의 이전 상태.                               |
| `new_senior_faq`  | VARCHAR(3000), NOT NULL              | 시니어 FAQ의 새로운 상태.                             |
...
| `faq_id`          | INT, DEFAULT NULL                    | 관련 FAQ의 ID. `faqs` 테이블의 외래 키. |
| `feedback_reason` | VARCHAR(255), DEFAULT NULL           | 피드백 이유.                            |
